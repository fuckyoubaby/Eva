...
import com.utility.excel.test.EmployeeExample;
...
public abstract class ExcelHelper {
	...
	/**
	 * 抽象方法：将制定excel文件中的数据转换成数据列表，由子类实现
	 * @param clazz
	 * 			数据类型
	 * @param fieldNames
	 * 			属性列表
	 ...
	 */
	public abstract String readExcelInPosition(CellPosition position) throws Exception;
	 ...
	 * @throws Exception
	 */
	public abstract List<String> getSheetNames() throws Exception;
