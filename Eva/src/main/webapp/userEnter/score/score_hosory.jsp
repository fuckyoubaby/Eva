...
<html>
	<head>
		...
		<style type="text/css">
			...
			/*--start 表头排序--*/
			.r_table table th.p-hover{-webkit-user-select:none;/* Chrome all / Safari all */
	...
	<body>
		<div class="container">
			...
			<div class="r_title">
				...
				<table class="table ">
					<thead><tr>
						<th class="p-hover" data-colname='name'>评分名称<i class="glyphicon glyphicon-sort icon-hidden"></i></th>
						<th class="p-hover" data-colname='startTime'>开始时间<i class="glyphicon glyphicon-sort icon-hidden"></i></th>
						<th class="p-hover" data-colname='endTime'>结束时间<i class="glyphicon glyphicon-sort icon-hidden"></i></th>
					...
					<tbody id="tbody">
						<tr>
							...
							<td class="t_td">
								<div class="t_action">
									<a href="score_main.html" class="a_see glyphicon glyphicon-eye-open" title="查看" ></a>
								</div>
							</td>
						</tr>
						<tr>
		...
		var chProject = {
			...
			load:function(pno,psize,callback){
				...
				$.ajax({
					...
					data:params,
					//配置请求地址，返回结果是jsp模板页面
					url:"basePath"+"/common/userTemplate.jsp",
