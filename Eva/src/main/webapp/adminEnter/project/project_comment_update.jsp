  ...
  <body>
	...
	<c:choose>
		...
		<c:otherwise>
   		...
   		<div class="container">
			<h3 class="bolder">设计评审信息修改</h3>
			<div class="hr mg-b15"></div>
			<div class="row">
				<div class="col-md-6">
					<div class="form-border">
						<div class="form-title">评审信息</div>
						<form id="comment_add" action="${basePath}/commentAction!updateComment.action" role="form" class="form-content" method="post">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									placeholder="评审日期" style="cursor:not-allowed"  value="${comment.date}"/>
