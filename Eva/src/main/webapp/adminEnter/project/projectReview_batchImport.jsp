...
<html>
	...
	<body>
	<fmt:formatDate value="${now}" type="both" dateStyle="long" pattern="yyyy-MM-dd" var="maxDate"/>
		<div class="container">
			<h3 class="bolder mg-b20">各项目项目评审批量录入</h3>
			<div class="hr mg-b15"></div>
			<div class="mg-b15">要导入的评审：项目评审</div>
			<div class="hr mg-b15"></div>	
				...
				<div>
					...
					<div class="form-inline mg-b15"> 
						...
						<div class="input-group">
							...
							<span class="input-group-addon" onclick="WdatePicker({el:'modifyDate',dateFmt:'yyyy-MM-dd',realDateFmt:'yyyy-MM-dd',minDate:'2015-01-01',maxDate:'${maxDate}'})">
