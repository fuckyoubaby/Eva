		...
		<script type="text/javascript">
			...
			//状态监视
			 uploader.on( 'all', function( type ) {
			    ...
			    var importFileUrl='${basePath}/fileUploadAction!importFile.action';
			    function loadData(url,datas,callback){
			    	var $tbody = $("#data-body");
			    	//console.log(baseDirc);
			    	var params = {itemName:'employee'};
			    ...
			    function importFile(){
			    	...
			    	$btn.text("处理中...");
			    	var datas ={importFileName:importFileName};
