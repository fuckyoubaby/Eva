...
<body>
	<div class="container">
			...
			<!-- <div class="main-header clearfix">
					<span class="main-header-message pull-right">
						<ul>
							...
							<li>
								<div>员工总数<em>120</em></div>
							</li>
						</ul>
					</span>
					<span class="main-header-name pull-left">员工信息总览</span>
				</div> -->
		</div>
				...
				<div class="form-inline row">
					<div class="col-md-6 form-group">
						...
						<button type="button" class="btn btn-info"
							onclick="searchKeyword()">搜索</button>
					</div>
				</div>
				<!--end the table process area-->
				</form>
			</div>
			<form id="dele_pro" action="employeeAction!muldelete.action"
				method="post">
				<!--start table area-->
				<div class="r_table">
					<table class="table">
			...
			<div class="r_footer row">
				<div class="col-md-6">
					<div class="r_delete pull-left">
						<a onclick="employeeDelete();" class="btn btn-info">删除所选</a>
					</div>
					<div class="clear"></div>
				</div>
				<div class="col-md-6">
					...
					var chUser = {
						...
						load : function(pno, psize, callback) {
							...
							$.ajax({
										...
										data : params,
										//配置请求地址，返回结果是jsp模板页面
										url : "employeeAction!getEmployeesByPage.action",///employeeAction!getEmployeesByPage.action
		...
		<div class="main-process">
			<a href="employeeAction!getJobList.action" class="btn btn-info"><i
				class="glyphicon glyphicon-plus icon-padr"></i>新增员工</a> <a
				href="employee_b_add.jsp" class="btn btn-info"
				style="margin-left:30px;"><i
				class="glyphicon glyphicon-import icon-padr"></i>批量导入</a>
