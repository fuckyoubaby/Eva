	...
	<body>
		<div class="container">
			...
			<div class="r_title">
				...
				<table class="table ">
					<thead><tr>
						<th class="p-hover" data-colname='employee.name'>员工姓名<i class="glyphicon glyphicon-sort icon-hidden"></i></th>
						<th class="p-hover" data-colname='employee.id'>员工编号<i class="glyphicon glyphicon-sort icon-hidden"></i></th>
						<th class="p-hover" data-colname='compliance'>合规扣分<i class="glyphicon glyphicon-sort icon-hidden"></i></th>
						<th class="p-hover" data-colname='designAbility'>专业技术<i class="glyphicon glyphicon-sort icon-hidden"></i></th>
						<th class="p-hover" data-colname='learningAbility'>自我成长<i class="glyphicon glyphicon-sort icon-hidden"></i></th>
						<th class="p-hover" data-colname='work'>对公司贡献<i class="glyphicon glyphicon-sort icon-hidden"></i></th>
						<th class="p-hover" data-colname='communication'>沟通管理<i class="glyphicon glyphicon-sort icon-hidden"></i></th>
						<th>操作</th>
					</tr></thead>
					<tbody id="tbody">
							<tr>
	...
	<script type="text/javascript">
		var chProject = {
			...
			load:function(pno,psize,callback){
				...
				if(chProject.orders){$.extend(params,chProject.orders);}
				//第二种方式,load原理代码
				$.ajax({
					type:"post",
					data:params,
					//配置请求地址，返回结果是jsp模板页面
					url:"scoreAction!getResultByModeId.action",
