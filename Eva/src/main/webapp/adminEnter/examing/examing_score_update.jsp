				...
				<div class="row">
						...
						<div class="form-border">
							...
							<div class="form-content">
								<div class="form-group">
									...
									<div class="form-control-static">${employeeexamr.exam.examName }</div>
								</div>
								<div class="form-group">
									<label class="control-label">组织者</label>
									<div class="form-control-static">${employeeexamr.exam.organizer }</div>
								</div>
								<div class="form-group">
									<label class="control-label">时间</label>
									<div class="form-control-static">${employeeexamr.exam.examTime }</div>
								</div>
							</div>
						</div>	
					</div>
					...
					<div class="col-md-6">
						<div class="form-border">
							...
							<form action="examAction!updateExamSocre.action" role="form" id="examGradeAdd" class="form-content">
								<div class="form-group">
									<label class="control-label">参与者</label>
									<div class="form-control-static">
										<label>${employeeexamr.employee.name }</label>
									</div>
									<!-- <div class="form-control-static">需选择<a href="javascript:void(0);">（添加）</a></div> -->
								</div>
								<div class="form-group">
									<label class="control-label">成绩</label>
									<input type="text" name="score" value="${employeeexamr.score }" class="form-control"/>
								</div>
