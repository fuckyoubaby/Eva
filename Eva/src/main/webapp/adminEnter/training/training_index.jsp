		...
		<div class="container">
			<!-- <div class="row first-row">
				<div class="main-header clearfix">
					<span class="main-header-message pull-right">
						<ul>
							<li>
								<div>本年培训<em>12</em></div>
							</li>
							<li>
								<div>累积组织培训<em>120</em></div>
							</li>
							<li>
					...
					<span class="main-header-name pull-left">培训信息总览</span>
				</div>
			</div> -->
			<div class="main-table">
				...
				<div class="r_title">
					...
					<span class="table-title">培训数据展示</span>
				<!--end table title-->
				</div>
				...
				<!--start table area-->
				<form id="dele_pro" action="trainAction!muldelete.action" method="post">
				<div class="r_table">
					<table class="table">
						<thead>
							<tr>
				...
				<div class="r_footer row">
					<div class="col-md-6">
						<div class="r_delete pull-left">
							<a onclick="trainDelete();" class="btn btn-info">删除所选</a>
						</div>
						<div class="clear"></div>
					</div>
					<div class="col-md-6">
			...
			<div class="main-process">
					<a href="trainAction!getAllForTrain.action" class="btn btn-info"><i class="glyphicon glyphicon-plus icon-padr"></i>新增培训</a>
		...
		var chUser = {
			...
			load:function(pno,psize,callback){
				...
				$.ajax({
					...
					data:params,
					//配置请求地址，返回结果是jsp模板页面
					url:"trainAction!getTrainByPage.action",
