...
<html>
	<head>
		...
		<script src="<%=basePath %>/js/chosen.jquery.min.js" type="text/javascript" charset="utf-8"></script>
	...
	<body>
		<div class="container">
			<h3 class="bolder mg-b15">新增培训</h3>
			<div class="hr mg-b20"></div>
			<div class="row">
				<form action="trainAction!save.action" id="addTrainForm">  <!-- trainAction!save.action -->
				<div class="col-md-6">
					<div class="form-border">
						...
						<div class="form-content">
							...
							<div class="form-group">
								<label  class="contorl-label">培训内容</label>
								<textarea rows="5" name="trainContent" class="form-control"></textarea>
							</div>
	
							<div class="form-group">
								<label  class="contorl-label">培训通知</label>
								<textarea rows="5" name="information" class="form-control"></textarea>
							</div>
						</div>
					</div>
						...
						<div class="form-content">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="date" name="trainData" id="trainData" class="form-control" readonly="readonly" style="cursor:not-allowed" />
							...
							<div class="form-group">
								...
								<!-- <div class="form-control-static">点击添加(<a href="javascript:void(0);">添加</a>)</div> -->
								<select name="employeeList" id="employeeList" multiple="multiple" class="form-control">
									<%-- <c:forEach items="${employees }" var="employee" varStatus="status">
										<option value="${employee.id }">${employee.name }</option>
									</c:forEach> --%>
									<c:forEach items="${employeeMap }" var="map">
							...
							<div class="form-group">
								<button type="submit"  id="addtrain" onclick="clickSubmit()" class="btn btn-info"><i class="glyphicon glyphicon-saved icon-padr"></i>保存数据</button>
							</div>
						</div>
					</div>
				</div>	
		...
		<script type="text/javascript">
			...
			function pickedFunc()
			{
				$('#addTrainForm').data('bootstrapValidator')  
			...
			function clickSubmit()
			{
			     ...
			     * */
			     	...
			     	$('#addTrainForm').bootstrapValidator({
